                    ...
                    <div class="card-body p-3 position-relative">
                        <div class="row">
                            <div class="col-7 text-start">
                                <p class="text-sm mb-1 text-capitalize font-weight-bold">Tổng số sản phẩm</p>
            ...
            <div class="col-sm-4 mt-sm-0 mt-4">
                <div class="card">
                    <div class="card-body p-3 position-relative">
                        <div class="row">
                            <div class="col-7 text-start">
                                <p class="text-sm mb-1 text-capitalize font-weight-bold">Thành viên</p>
                                <h5 class="font-weight-bolder mb-0">
                                    <?php echo $customer ?>
                                </h5>
            ...
            <div class="col-sm-4 mt-sm-0 mt-4">
                <div class="card">
                    <div class="card-body p-3 position-relative">
                        <div class="row">
                            <div class="col-7 text-start">
                                <p class="text-sm mb-1 text-capitalize font-weight-bold">Số đơn hàng</p>
                                <h5 class="font-weight-bolder mb-0">
                                    <?php echo $order ?>
                                </h5>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body pb-0 p-3 mt-4">
                        <div class="row">
                            <div class="col-7 text-start">
                                <div class="chart">
                                    <canvas id="chart-pie" class="chart-canvas" height="200" width="272"
                                        style="display: block; box-sizing: border-box; height: 200px; width: 272.7px;"></canvas>
                                </div>
                            </div>
            ...
            <div class="col-lg-8 col-sm-6 mt-sm-0 mt-4">
                <div class="card">
                    ...
                    <div class="card-body p-3">
                        <div class="chart">
                            <canvas id="chart-line" class="chart-canvas" height="300" width="1025"
                                style="display: block; box-sizing: border-box; height: 300px; width: 1025.3px;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-4">
            <div class="col-lg-8">
                <div class="card h-100">
                    ...
                    <div class="card-body p-3">
                        <div class="chart">
                            <canvas id="chart-bar" class="chart-canvas" height="340" width="1025"
                                style="display: block; box-sizing: border-box; height: 340px; width: 1025.3px;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <li class="list-group-item px-0 border-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <img src="https://material-dashboard-pro-laravel.creative-tim.com/assets/img/icons/flags/US.png"
                                            alt="Country flag">
                                    </div>
                                    <div class="col">
                            ...
                            <li class="list-group-item px-0 border-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <img src="https://material-dashboard-pro-laravel.creative-tim.com/assets/img/icons/flags/DE.png"
                                            alt="Country flag">
                                    </div>
                                    <div class="col">
                                        <p class="text-xs font-weight-bold mb-0">Country:</p>
                            ...
                            <li class="list-group-item px-0 border-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <img src="https://material-dashboard-pro-laravel.creative-tim.com/assets/img/icons/flags/GB.png"
                                            alt="Country flag">
                                    </div>
                                    <div class="col">
                                        <p class="text-xs font-weight-bold mb-0">Country:</p>
                            ...
                            <li class="list-group-item px-0 border-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <img src="https://material-dashboard-pro-laravel.creative-tim.com/assets/img/icons/flags/BR.png"
                                            alt="Country flag">
                                    </div>
                                    <div class="col">
                                        <p class="text-xs font-weight-bold mb-0">Country:</p>
                            ...
                            <li class="list-group-item px-0 border-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <img src="https://material-dashboard-pro-laravel.creative-tim.com/assets/img/icons/flags/AU.png"
                                            alt="Country flag">
                                    </div>
                                    <div class="col">
                                        <p class="text-xs font-weight-bold mb-0">Country:</p>
